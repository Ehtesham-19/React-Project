...
export default function AddStudentForm() {
  ...
  const mutation = useMutation({
    mutationFn: async (newStudent) => {
      // Convert file to just its name for JSON Server
      const payload = { ...newStudent, photo: newStudent.photo?.name || "" };
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-end gap-3">
          <button
            type="button"
            className="px-6 py-2.5 border-2 border-purple-600 text-purple-600 rounded-lg font-medium hover:bg-purple-50 transition-colors"
          >
            Save as Draft
          </button>
          <button
            type="submit"
            className="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg font-medium hover:from-purple-700 hover:to-purple-800 transition-colors shadow-md"
          >
            Submit
          </button>
        </div>
